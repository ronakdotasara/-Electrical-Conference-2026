  ...
  return (
      ...
      <div className='fm'>
        ...
        <div className='footerleft'>
            ...
            <p className='footerleftpone'>This site is created, maintained, and managed by the Organizing Committee of PICS-2026, Department of Electrical Engineering, National Instituteof Technology Hamirpur.</p>
